        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Phone Cases</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Wireless Chargers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Screen Protectors</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Accessories</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Shipping Info</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Returns</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors font-light">Size Guide</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors font-light text-sm">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
