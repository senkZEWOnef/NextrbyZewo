  ...
  if (!insights) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-500">Failed to load customer insights</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{insights.totalCustomers.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{insights.newCustomers}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{customerRetentionRate.toFixed(1)}%</p>
              <p className="text-xs text-blue-600">Returning customers</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">${insights.averageLifetimeValue}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top Regions */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Top Regions</h4>
                ...
                <div key={region.region} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-sm text-gray-600">{region.customers} customers</span>
                    </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h4 className="text-lg font-medium text-gray-900 mb-4">Customer Behavior Insights</h4>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center border rounded-lg p-4">
            <div className="text-2xl mb-2">📱</div>
            <h5 className="font-medium text-gray-900 mb-1">Mobile Users</h5>
            <p className="text-2xl font-semibold text-gray-900">68%</p>
            <p className="text-xs text-gray-500">Primary shopping device</p>
          </div>
          
          <div className="text-center border rounded-lg p-4">
            <div className="text-2xl mb-2">🛒</div>
            <h5 className="font-medium text-gray-900 mb-1">Avg Cart Size</h5>
          ...
          <div className="text-center border rounded-lg p-4">
            ...
            <h5 className="font-medium text-gray-900 mb-1">Session Time</h5>
            <p className="text-2xl font-semibold text-gray-900">8.5m</p>
            <p className="text-xs text-gray-500">Average visit duration</p>
          </div>
        </div>
      </div>
    </div>
