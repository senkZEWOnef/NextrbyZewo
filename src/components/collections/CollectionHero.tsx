  ...
  return (
    <section className="relative min-h-[80vh] bg-black flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-light text-white mb-6 tracking-tight leading-tight">
            Collections
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="bg-white text-black px-8 sm:px-10 py-4 text-base sm:text-lg font-medium hover:bg-gray-100 transition-colors min-w-[200px] sm:min-w-[220px] group">
          ...
          <button className="border border-white text-white px-8 sm:px-10 py-4 text-base sm:text-lg font-light hover:bg-white hover:text-black transition-colors min-w-[200px] sm:min-w-[220px]">
            Watch the Story
          </button>
        </div>
      </div>
